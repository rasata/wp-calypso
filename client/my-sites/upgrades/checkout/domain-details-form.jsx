...
const wpcom = wp.undocumented(), countriesList = countriesListForDomainRegistrations();
...
export class DomainDetailsForm extends PureComponent {
	...
	handleSubmitButtonClick = event => {
		...
		this.formStateController.handleSubmit( hasErrors => {
			...
			if (
				this.allDomainRegistrationsSupportPrivacy() && ! this.allDomainRegistrationsHavePrivacy()
			) {
				this.openDialog();
				return;
			}
