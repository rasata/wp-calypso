...
import MinimumJetpackVersionNotice from 'my-sites/plugins/minimum-jetpack-version-notice';
...
const PluginsBrowser = React.createClass( {
	...
	render() {
		if ( ! this.props.isRequestingSites && this.props.notAvailableError ) {
...
export default connect(
	state => {
		...
		return {
			selectedSiteId,
			notAvailableError: !! selectedSiteId && ! canCurrentUser( state, selectedSiteId, 'manage_options' ),
