	...
	render: function() {
		...
		switch ( this.props.pageNumber ) {
			case '...':
				...
				break;
			case '<--':
				listClass = classNames( 'stats-pagination__list-item stats-pagination__arrow', 'is-left', {
				...
				break;
			case '-->':
				listClass = classNames( 'stats-pagination__list-item stats-pagination__arrow', 'is-right', {
				...
				break;
			default:
				listClass = classNames( 'stats-pagination__list-item stats-pagination__page-number', {
