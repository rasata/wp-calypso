...
class PressableStoreStep extends Component {
	...
	onSubmit = event => {
		...
		window.open(
			`https://my.pressable.com/signup/ecommerce-five-sites?email=${ encodeURIComponent( this.state.email ) }&utm_source=wordpresscom&utm_medium=signupref&utm_campaign=wpcomecomm3`,
		);
	};
