...
class DomainWarnings extends React.PureComponent {
	...
	wrongNSMappedDomains = () => {
		...
		let learnMoreUrl, text, offendingList = null;
		...
		if ( this.props.isCompact ) {
			...
			children = (
				<span>
					{ text } <a href={ learnMoreUrl } target="_blank" rel="noopener noreferrer">
	...
	expiredDomainsCannotManage = () => {
		...
		return (
			<Notice isCompact={ this.props.isCompact } showDismiss={ false } key={ key } text={ text }>
				{ this.trackImpression( key, expiredDomains.length ) }
			</Notice>
		);
	};
