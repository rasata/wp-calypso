...
const SiteNotice = React.createClass( {
	...
	jetpackPluginsSetupNotice() {
		if (
			! this.props.pausedJetpackPluginsSetup || this.props.site.plan.product_slug === 'jetpack_free'
		) {
			return null;
		}
...
export default connect(
	( state, ownProps ) => {
		...
		return {
			...
			pausedJetpackPluginsSetup: isJetpackPluginsStarted( state, siteId ) &&
				! isJetpackPluginsFinished( state, siteId ),
		};
	},
	dispatch => {
		return {
